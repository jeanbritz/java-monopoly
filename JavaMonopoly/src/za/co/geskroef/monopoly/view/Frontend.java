...
import za.co.geskroef.monopoly.view.framework.Viewable;
...
public class Frontend extends JFrame implements Viewable, Runnable {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see za.co.geskroef.monopoly.views.Viewable#initView()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see za.co.geskroef.monopoly.views.FrontendViewable#updateView()
	 */
	@Override
